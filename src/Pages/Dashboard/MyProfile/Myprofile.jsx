                ...
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="relative px-8 py-10">
                        ...
                        <div className="mt-16 grid md:grid-cols-2 gap-8">
                            {/* Account Information */}
                            <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-2xl border-2" style={{ borderColor: '#e0ecff' }}>
                            ...
                            {/* Account Status */}
                            <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-2xl border-2" style={{ borderColor: '#f3e8ff' }}>
                                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6" style={{ color: '#5089e6' }}>
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-2xl border-2" style={{ borderColor: '#dcfce7' }}>
                                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6" style={{ color: '#5089e6' }}>
                            ...
                            {/* Security & Settings */}
                            <div className="bg-gradient-to-br from-orange-50 to-white p-6 rounded-2xl border-2" style={{ borderColor: '#ffedd5' }}>
                                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6" style={{ color: '#5089e6' }}>
