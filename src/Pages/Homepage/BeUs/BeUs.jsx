        ...
        <div className='bg-primary flex flex-col md:flex-row justify-around items-center p-10 md:p-16 mt-20 rounded-2xl shadow-2xl'>
            ...
            <div className='text-white w-full md:w-2/3 text-left'>
                ...
                <div className='m-1 gap-4 flex flex-col sm:flex-row'>
                    <Link to={"/products"} className="btn btn-primary border-white rounded-full text-white font-semibold hover:scale-105 transition-transform">Start Your Buying Journey</Link>
                    <Link to={"/register"} className="btn bg-transparent border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-blue-700 transition-all">Sell Your First Product</Link>
                </div>
            </div>
